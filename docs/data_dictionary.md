...
|avg_temperature_2m|Средняя температура воздуха на высоте 2 метра за день|°C|mean(temperature_2m)|
|avg_relative_humidity_2m|Средняя влажность воздуха на высоте 2 метра за день|%|mean(relative_humidity_2m)|
|sum_precipitation|Сумма осадков за день|mm|sum(precipitation)|
|avg_wind_speed_10m|Средняя скорость ветра на высоте 10 метров за день|km/h|mean(wind_speed_10m)|
