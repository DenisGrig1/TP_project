...
|temperature_2m|float64|нет|Средняя температура воздуха в градусах Цельсия на высоте 2 метра за день|9.1|
|relative_humidity_2m|float32|нет|Средняя влажность воздуха в процентах на высоте 2 метра за день|96.0|
|precipitation|float64|нет|Сумма осадков в мм за день|0.0|
|wind_speed_10m|float64|нет|Средняя скорость ветра в км/ч на высоте 10 метров за день|7.3|
...
## 5. Допущения и единицы измерения
- Температура: °C
- Время: UTC
- Единицы измерения фиксируются в contract

## 6. Версионирование
- 0.5 (2026-04-24): Добавлены схема mart, разделы "Допущения и единицы измерения", "Что означает 1 строка"
